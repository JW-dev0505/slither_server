 ...
 */
public class Main {
    private static final String KEYSTORE_PASSWORD = "123456789"; // Replace with your keystore password
    private static final String KEYSTORE_PATH = "keystore.jks"; // Replace with the path to your keystore
